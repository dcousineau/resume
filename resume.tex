...
{Co-founder \& Head of Engineering}
{
  ...
  \item AWS multi-account, Cloudformation+CDK, Fargate execution of containerized Node.js based services (Next.js and Fastify)
  \item Built a secure MCP to allow customers to interact with our platform using their own LLM tooling.
